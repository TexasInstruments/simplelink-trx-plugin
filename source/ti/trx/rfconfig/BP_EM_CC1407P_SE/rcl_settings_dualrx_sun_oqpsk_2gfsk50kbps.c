...
#include "rcl_settings_dualrx_sun_oqpsk_2gfsk50kbps.h"


// Configuration: FRONTEND
const uint32_t LRF_frontendRegConfig_dualrxSunOqpsk2gfsk50kbps[] =
{
...
const uint32_t LRF_frontendRegConfig_dualrxSunOqpsk2gfsk50kbps_byteCount = sizeof(LRF_frontendRegConfig_dualrxSunOqpsk2gfsk50kbps);


// Configuration: MAIN
const uint32_t LRF_mainRegConfig_dualrxSunOqpsk2gfsk50kbps[] =
{
    0x000080AB,    // 1 segment(s), total length = 171
    0x000000AA,    // Segment length = 170
    ...
    0x0001132E,    //         LRFDPBE.SPARE1           PBE_FW.PKTCFG
...
const uint32_t LRF_mainRegConfig_dualrxSunOqpsk2gfsk50kbps_byteCount = sizeof(LRF_mainRegConfig_dualrxSunOqpsk2gfsk50kbps);

// TRX_TxPowerLevels data structure
const TRX_TxPowerLevels TRX_txPowerLevels_dualrxSunOqpsk2gfsk50kbps = {
    .numEntries  = 0x18,
    .powerLevels = {
        { .fraction = 0, .dBm = -30 },
        { .fraction = 0, .dBm = -20 },
...
// TRX_TxPowerLevels data structure
const TRX_TxPowerLevels TRX_txPowerLevelsHigh_dualrxSunOqpsk2gfsk50kbps = {
    .numEntries  = 0x13,
    .powerLevels = {
        { .fraction = 0, .dBm =   0 },
        { .fraction = 0, .dBm =   5 },
