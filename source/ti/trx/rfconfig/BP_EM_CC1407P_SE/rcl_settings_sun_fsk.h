...
#ifndef RCLSETTINGSSUNFSK_H
#define RCLSETTINGSSUNFSK_H
...
// PHY features
#define TRX_PHY_FEATURE_FEC_MODE_IN_TX_OFF_SUN_FSK    0x0000
#define TRX_PHY_FEATURE_FEC_MODE_IN_TX_ON_SUN_FSK     0x0001
#define TRX_PHY_FEATURE_FSK_MODE_1A_SUN_FSK           0x0000
#define TRX_PHY_FEATURE_FSK_MODE_1B_SUN_FSK           0x0002
#define TRX_PHY_FEATURE_FSK_MODE_2A_SUN_FSK           0x0004
#define TRX_PHY_FEATURE_FSK_MODE_2B_SUN_FSK           0x0008
#define TRX_PHY_FEATURE_FSK_MODE_3_SUN_FSK            0x0010
#define TRX_PHY_FEATURE_FSK_MODE_4A_SUN_FSK           0x0020
#define TRX_PHY_FEATURE_FSK_MODE_4B_SUN_FSK           0x0040
#define TRX_PHY_FEATURE_FSK_MODE_5_SUN_FSK            0x0080


// Supported clock configuration
#define TRX_CLOCK_CONFIG_SUN_FSK                      TRX_ClockConfig_XOSC

// Supported RF mode
#define TRX_RF_MODE_SUN_FSK                           TRX_RfMode_SUN


// Configuration: FRONTEND
extern const uint32_t LRF_frontendRegConfig_sunFsk[];
// Configuration length: FRONTEND
extern const uint32_t LRF_frontendRegConfig_sunFsk_byteCount;
// Configuration: MAIN
extern const uint32_t LRF_mainRegConfig_sunFsk[];
// Configuration length: MAIN
extern const uint32_t LRF_mainRegConfig_sunFsk_byteCount;


// TRX data structures
extern const TRX_TxPowerLevels	TRX_txPowerLevels_sunFsk;
extern const TRX_TxPowerLevels	TRX_txPowerLevelsHigh_sunFsk;
