...
#include "rcl_settings_dualrx_sun_ofdm_o3_2gfsk50kbps.h"


// Configuration: FRONTEND
const uint32_t LRF_frontendRegConfig_dualrxSunOfdmO32gfsk50kbps[] =
{
...
const uint32_t LRF_frontendRegConfig_dualrxSunOfdmO32gfsk50kbps_byteCount = sizeof(LRF_frontendRegConfig_dualrxSunOfdmO32gfsk50kbps);


// Configuration: MAIN
const uint32_t LRF_mainRegConfig_dualrxSunOfdmO32gfsk50kbps[] =
{
    ...
    0x00000203,    //         TRX_swParam : radioRequirements.defaultModem, radioRequirements.supportedRfModes
    ...
    0x00003026,    //     HW sparse region (address/value pairs, count = 39)
    ...
    0x30E40088,    //         LRFDRFE.RX1BDEC
    0x30EC0015,    //         LRFDRFE.RX1CICHF
    0x3110C6A3,    //         RFE_FW.AGCCFG0
    ...
    0x61AC0002,    //         OCE_MAIN_FW.FWCFG3
    0x62200000,    //         LRFDOCE.IFFTSAT
    0x11641001,    //     HW 16-bit region (start address = 0x1164, count = 2)
    0x02010083,    //         PBE_FW.OFDM0                 PBE_FW.FSKCFG
    ...
    0x3F8D0009,    //         LRFDMCE.DEMENSHDW1           LRFDMCE.DEMENSHDW0
    0x01800000,    //         LRFDMCE.DEMDSXB0             < GAP >
    ...
    0x21801004,    //     HW 16-bit region (start address = 0x2180, count = 5)
    0x00060044,    //         LRFDMCE.DEMWMPRE             LRFDMCE.DEMWMCFG
    0x00150008,    //         LRFDMCE.DEMWMSYNC            LRFDMCE.DEMWMPTHR
    0x00000008,    //         -                            LRFDMCE.DEMWMSTHR
    ...
    0x140F140F,    //         LRFDRFE.RX0MAGNCTRL1         LRFDRFE.RX0MAGNCTRL0
    0x000018FF,    //         -                            LRFDRFE.RX0MAGNCTRL2
    ...
    0x206A93C5,    //         RFE_FW.AGCCFG3               RFE_FW.AGCCFG2
    0x319C1001,    //     HW 16-bit region (start address = 0x319C, count = 2)
    0x00070212,    //         LRFDRFE.RFECTL1              LRFDRFE.RFECTL0
    0x31BC1001,    //     HW 16-bit region (start address = 0x31BC, count = 2)
    0x0036430A,    //         LRFDRFE.IFAMP                LRFDRFE.LNA
    ...
    0x004C50B0,    //         RFE_FW.PHYRX0RSSI            LRFDRFE.SPARE0
    0x122C004D,    //         RFE_FW.PHYAGCCFG4            RFE_FW.PHYRX1RSSI
    0x200000D0,    //         RFE_FW.RXFRONTEND            RFE_FW.RXCODCCFG2
    0x00080003,    //         RFE_FW.IFADCPEAKTHR          RFE_FW.AGCCFG5
    0x33B81002,    //     HW 16-bit region (start address = 0x33B8, count = 3)
    0x00000000,    //         RFE_FW.FEDELTANOISEFIGURE    RFE_FW.FEDELTARSSI
    0x0000001C,    //         -                            RFE_FW.AGCCFG6
    0x60D01003,    //     HW 16-bit region (start address = 0x60D0, count = 4)
    0x3580DC17,    //         LRFDOCE.SUNDEM0              LRFDOCE.SUNMOD0
    0x50062100,    //         LRFDOCE.SUNDEM2              LRFDOCE.SUNDEM1
    0x60F41002,    //     HW 16-bit region (start address = 0x60F4, count = 3)
    0x1F040800,    //         LRFDOCE.SUNPILOT0            LRFDOCE.SUNCORR3
    0x000094D3,    //         -                            LRFDOCE.SUNPILOT1
...
const uint32_t LRF_mainRegConfig_dualrxSunOfdmO32gfsk50kbps_byteCount = sizeof(LRF_mainRegConfig_dualrxSunOfdmO32gfsk50kbps);

// TRX_TxPowerLevels data structure
const TRX_TxPowerLevels TRX_txPowerLevels_dualrxSunOfdmO32gfsk50kbps = {
    .numEntries  = 0x18,
    .powerLevels = {
        { .fraction = 0, .dBm = -30 },
        { .fraction = 0, .dBm = -20 },
...
// TRX_TxPowerLevels data structure
const TRX_TxPowerLevels TRX_txPowerLevelsHigh_dualrxSunOfdmO32gfsk50kbps = {
    .numEntries  = 0x13,
    .powerLevels = {
        { .fraction = 0, .dBm =   0 },
        { .fraction = 0, .dBm =   5 },
