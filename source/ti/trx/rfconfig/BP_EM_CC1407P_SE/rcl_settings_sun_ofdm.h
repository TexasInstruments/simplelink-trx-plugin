...
#ifndef RCLSETTINGSSUNOFDM_H
#define RCLSETTINGSSUNOFDM_H
...
// PHY features
#define TRX_PHY_FEATURE_OFDM_OPTION_1_SUN_OFDM         0x0000
#define TRX_PHY_FEATURE_OFDM_OPTION_2_SUN_OFDM         0x0001
#define TRX_PHY_FEATURE_OFDM_OPTION_3MCS0_SUN_OFDM     0x0002
#define TRX_PHY_FEATURE_OFDM_OPTION_3MCS16_SUN_OFDM    0x0004
#define TRX_PHY_FEATURE_OFDM_OPTION_4MCS01_SUN_OFDM    0x0008
#define TRX_PHY_FEATURE_OFDM_OPTION_4MCS26_SUN_OFDM    0x0010


// Supported clock configuration
#define TRX_CLOCK_CONFIG_SUN_OFDM                      TRX_ClockConfig_XOSC

// Supported RF mode
#define TRX_RF_MODE_SUN_OFDM                           TRX_RfMode_SUN


// Configuration: FRONTEND
extern const uint32_t LRF_frontendRegConfig_sunOfdm[];
// Configuration length: FRONTEND
extern const uint32_t LRF_frontendRegConfig_sunOfdm_byteCount;
// Configuration: MAIN
extern const uint32_t LRF_mainRegConfig_sunOfdm[];
// Configuration length: MAIN
extern const uint32_t LRF_mainRegConfig_sunOfdm_byteCount;


// TRX data structures
extern const TRX_TxPowerLevels	TRX_txPowerLevels_sunOfdm;
extern const TRX_TxPowerLevels	TRX_txPowerLevelsHigh_sunOfdm;
