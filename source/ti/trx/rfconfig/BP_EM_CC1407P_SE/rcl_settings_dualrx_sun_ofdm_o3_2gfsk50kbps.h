...
// PHY                                       779 - 930 MHz - Dual protocol SUN OFDM / 2-GFSK - Option 3 / 50 kbps, 25 kHz dev
//     State                                 Experimental
// PHY abbreviation                          dualrx_sun_ofdm_o3_2gfsk50kbps
//
//
// PHY PROPERTIES
//
// Dual protocol PHY overview:
//     PHY 0                                 SUN OFDM, Option 3 
//     PHY 1                                 2-GFSK, 50 kbps, 25 kHz dev 
// Common run-time properties:
//     SUN OFDM Frequency                    915.00000 MHz
//     GFSK Frequency                        915.00000 MHz
//     TX output power                       21.5 dBm (high output PA)
// PHY 0: SUN OFDM\Run-time properties:
...
// PHY 1: 2-GFSK\Start of packet detection: WaveMatch:
//     Preamble margin                       8 
...
#ifndef RCLSETTINGSDUALRXSUNOFDMO32GFSK50KBPS_H
#define RCLSETTINGSDUALRXSUNOFDMO32GFSK50KBPS_H
...
// PHY features
#define TRX_PHY_FEATURE_OFDM_OPTION_3MCS0_DUALRX_SUN_OFDM_O3_2GFSK50KBPS     0x0000
#define TRX_PHY_FEATURE_OFDM_OPTION_3MCS16_DUALRX_SUN_OFDM_O3_2GFSK50KBPS    0x0001


// Supported clock configuration
#define TRX_CLOCK_CONFIG_DUALRX_SUN_OFDM_O3_2GFSK50KBPS                      TRX_ClockConfig_XOSC

// Supported RF mode
#define TRX_RF_MODE_DUALRX_SUN_OFDM_O3_2GFSK50KBPS                           TRX_RfMode_PropFSKPeakAGC


// Configuration: FRONTEND
extern const uint32_t LRF_frontendRegConfig_dualrxSunOfdmO32gfsk50kbps[];
// Configuration length: FRONTEND
extern const uint32_t LRF_frontendRegConfig_dualrxSunOfdmO32gfsk50kbps_byteCount;
// Configuration: MAIN
extern const uint32_t LRF_mainRegConfig_dualrxSunOfdmO32gfsk50kbps[];
// Configuration length: MAIN
extern const uint32_t LRF_mainRegConfig_dualrxSunOfdmO32gfsk50kbps_byteCount;


// TRX data structures
extern const TRX_TxPowerLevels	TRX_txPowerLevels_dualrxSunOfdmO32gfsk50kbps;
extern const TRX_TxPowerLevels	TRX_txPowerLevelsHigh_dualrxSunOfdmO32gfsk50kbps;
...
// 0x115C     PBE_FW           PKTCFG                [13]       NEXTGENWH           0x0
...
// 0x115C     PBE_FW           PKTCFG                [8]        HDRBITREV           0x1
// 0x115C     PBE_FW           PKTCFG                [7]        HDRWHBEFORECRC      0x0
// 0x115C     PBE_FW           PKTCFG                [6]        HDRWHEN             0x0
// 0x115C     PBE_FW           PKTCFG                [5]        HDRCRCEN            0x1
// 0x115C     PBE_FW           PKTCFG                [4:3]      CRCSIZE             0x1
// 0x115C     PBE_FW           PKTCFG                [2]        WHCRCBITS           0x0
// 0x115C     PBE_FW           PKTCFG                [1]        WHITENER            0x0
// 0x115C     PBE_FW           PKTCFG                [0]        SUNMODE             0x0
// 0x1164     PBE_FW           FSKCFG                [9:7]      HDRLEN              0x1
// 0x1164     PBE_FW           FSKCFG                [6:4]      STARTBYTELEN        0x0
// 0x1164     PBE_FW           FSKCFG                [3:1]      HDRLENSIZE          0x1
// 0x1164     PBE_FW           FSKCFG                [0]        LENINHDR            0x1
// 0x1168     PBE_FW           OFDM0                 [9:8]      SUNOPTION           0x2
// 0x1168     PBE_FW           OFDM0                 [0]        SUNOFDM             0x1
// 0x118C     PBE_FW           TXPN9SEED             [8:0]      VAL                 0x1FF
// 0x1210     LRFDPBE          LFSR0N                [3:0]      SIZE                0x7
// 0x1220     LRFDPBE          LFSR1N                [3:0]      SIZE                0x7
...
// 0x20CC     LRFDMCE          DEMMISC0              [1:0]      RXFRONTSEL          0x2
...
// 0x213C     LRFDMCE          DEMCMIXFB2P           [1:0]      CTL                 0x1
...
// 0x21AC     MCE_MAIN_FW      FWCFG0                [13]       FB2PLLEN            0x1
// 0x21AC     MCE_MAIN_FW      FWCFG0                [11:8]     FB2PLLGAIN          0x2
// 0x21AC     MCE_MAIN_FW      FWCFG0                [7:0]      FB2PLLLIMIT         0x06
// 0x21B4     MCE_MAIN_FW      FWCFG2                [15]       PQTEN               0x0
// 0x21BC     MCE_SUNFSK_FW    WISUNPHYMODE          [7:4]      TYPE                0x0
...
// 0x3064     LRFDRFE          TXENABLE              [3]        INTP3               0x1
// 0x3064     LRFDRFE          TXENABLE              [2]        INTP2               0x1
...
// 0x30C0     LRFDRFE          RX0CICHF              [7:6]      CICDVGA             0x1
...
// 0x30CC     LRFDRFE          RX0MAGNCTRL1          [11:8]     SCALE               0x4
// 0x30CC     LRFDRFE          RX0MAGNCTRL1          [7:0]      PERIOD              0x0F
// 0x30D0     LRFDRFE          RX0MAGNCTRL2          [12]       PERMODE             0x1
// 0x30D0     LRFDRFE          RX0MAGNCTRL2          [11:8]     SCALE               0x8
// 0x30D0     LRFDRFE          RX0MAGNCTRL2          [7:0]      PERIOD              0xFF
// 0x30E4     LRFDRFE          RX1BDEC               [7:6]      BDE2DVGA            0x2
// 0x30E4     LRFDRFE          RX1BDEC               [3:2]      BDEC2NUMSTAGES      0x2
...
// 0x31A0     LRFDRFE          RFECTL1               [1]        RXCFG               0x1
// 0x31A0     LRFDRFE          RFECTL1               [0]        ULNA                0x1
// 0x31BC     LRFDRFE          LNA                   [15:14]    RXTX                0x1
// 0x31BC     LRFDRFE          LNA                   [11:8]     MIXCAP              0x3
...
// 0x31C0     LRFDRFE          IFAMP                 [7:4]      IFFCAP              0x3
...
// 0x3390     LRFDRFE          SPARE0                [15:0]     VAL                 0x50B0
// 0x3394     RFE_FW           PHYRX0RSSI            [7:0]      OFFSET              0x4C
// 0x3398     RFE_FW           PHYRX1RSSI            [7:0]      OFFSET              0x4D
// 0x339C     RFE_FW           PHYAGCCFG4            [15:8]     NOSIGNALTHR         0x12
// 0x339C     RFE_FW           PHYAGCCFG4            [7:0]      AGCIRQTHR           0x2C
// 0x33A0     RFE_FW           RXCODCCFG2            [7:5]      IIRGAINUSLOW        0x6
...
// 0x33A8     RFE_FW           AGCCFG5               [7:0]      DELTAGCREF          0x03
// 0x33AC     RFE_FW           IFADCPEAKTHR          [7:0]      THR                 0x08
// 0x33B8     RFE_FW           FEDELTARSSI           [15:0]     OFFSET              0x0000
// 0x33BC     RFE_FW           FEDELTANOISEFIGURE    [15:0]     VAL                 0x0000
// 0x33C0     RFE_FW           AGCCFG6               [15:0]     SLOPETHR            0x001C
// 0x33C8     RFE_FW           AGCCFG8               [15:0]     STOPCLIMBTHR        0x0055
// 0x33DC     RFE_FW           AGCCFG9               [15:0]     RX1FILTDLY          0x0006
// 0x60BC     LRFDOCE          MDM1                  [3]        LRRX1               0x0
// 0x60BC     LRFDOCE          MDM1                  [2]        LRRX0               0x0
// 0x60BC     LRFDOCE          MDM1                  [1]        SUNRX1              0x0
// 0x60BC     LRFDOCE          MDM1                  [0]        SUNRX0              0x1
// 0x60C4     LRFDOCE          SUNFFT0               [15]       DEMGAIN             0x1
// 0x60C4     LRFDOCE          SUNFFT0               [14:12]    MODGAIN             0x3
// 0x60C4     LRFDOCE          SUNFFT0               [11:10]    NDT                 0x2
// 0x60C4     LRFDOCE          SUNFFT0               [9:8]      RXDFTSZ             0x0
// 0x60C4     LRFDOCE          SUNFFT0               [7:4]      IFFTGAIN            0x2
// 0x60C4     LRFDOCE          SUNFFT0               [3:0]      FFTGAIN             0x6
// 0x60D0     LRFDOCE          SUNMOD0               [15:11]    MODFINEGAIN         0x1B
// 0x60D0     LRFDOCE          SUNMOD0               [10:9]     TXDFTSZ             0x2
// 0x60D0     LRFDOCE          SUNMOD0               [8:0]      TXINVIQFIRST        0x017
// 0x60D4     LRFDOCE          SUNDEM0               [15:0]     RXSIGNALREF         0x3580
// 0x60D8     LRFDOCE          SUNDEM1               [14:8]     RXFIRSTDATASAMPL    0x21
// 0x60D8     LRFDOCE          SUNDEM1               [7:0]      RXFIRSTLTFSAMPL     0x00
// 0x60DC     LRFDOCE          SUNDEM2               [14]       INVPOWERFREEZEEN    0x1
// 0x60DC     LRFDOCE          SUNDEM2               [13]       RXNORMMETHOD        0x0
// 0x60DC     LRFDOCE          SUNDEM2               [12:11]    RXUPSAMPLE          0x2
// 0x60DC     LRFDOCE          SUNDEM2               [8]        NORMCORRDIS         0x0
// 0x60DC     LRFDOCE          SUNDEM2               [7]        NORMFREEZE          0x0
// 0x60DC     LRFDOCE          SUNDEM2               [6:4]      NORMOFFSET          0x0
// 0x60DC     LRFDOCE          SUNDEM2               [3:0]      NORMPERIOD          0x6
// 0x60E8     LRFDOCE          SUNCORR0              [11]       STOPCORRBELOWTHR    0x1
// 0x60E8     LRFDOCE          SUNCORR0              [10:9]     MAXPEAKDECAY        0x0
// 0x60E8     LRFDOCE          SUNCORR0              [8]        STF1SPOSEDGETHR     0x0
// 0x60E8     LRFDOCE          SUNCORR0              [7]        STF1STHR            0x0
// 0x60E8     LRFDOCE          SUNCORR0              [6]        STOPCORR            0x0
// 0x60E8     LRFDOCE          SUNCORR0              [5]        HWCFOEN             0x1
// 0x60E8     LRFDOCE          SUNCORR0              [4]        NOTONEQUAL          0x1
// 0x60E8     LRFDOCE          SUNCORR0              [3]        CLEARBESTPEAK       0x0
// 0x60E8     LRFDOCE          SUNCORR0              [2]        SUPREARLYSYNCEN     0x1
// 0x60E8     LRFDOCE          SUNCORR0              [1:0]      S9WEIGTH            0x1
// 0x60F4     LRFDOCE          SUNCORR3              [11:0]     STFAVGTHR           0x800
// 0x60F8     LRFDOCE          SUNPILOT0             [15:8]     BETA                0x1F
// 0x60F8     LRFDOCE          SUNPILOT0             [7:0]      ALPHA               0x04
// 0x60FC     LRFDOCE          SUNPILOT1             [15:14]    CHFIBW              0x2
// 0x60FC     LRFDOCE          SUNPILOT1             [13:12]    TERRG               0x1
// 0x60FC     LRFDOCE          SUNPILOT1             [11:9]     TERRPER1            0x2
// 0x60FC     LRFDOCE          SUNPILOT1             [8:6]      TERRPERN            0x3
// 0x60FC     LRFDOCE          SUNPILOT1             [4:3]      IIRBW               0x2
// 0x60FC     LRFDOCE          SUNPILOT1             [2:0]      MU                  0x3
// 0x6110     LRFDOCE          SUNCORR4              [14:8]     STF_NORMCORRLVL     0x43
// 0x6110     LRFDOCE          SUNCORR4              [7]        POWERSAMPLELEN      0x1
// 0x6110     LRFDOCE          SUNCORR4              [5]        WIDEPEAKQUAL        0x1
// 0x6110     LRFDOCE          SUNCORR4              [4:0]      WIDEPEAKTHR         0x0F
// 0x6168     OCE_MAIN_FW      FWCFG4                [8]        PHRRESYNC           0x1
// 0x6178     OCE_MAIN_FW      FWCFG2                [15:12]    SPERIOD             0x4
// 0x6178     OCE_MAIN_FW      FWCFG2                [11:4]     PHR_LEN             0x06
// 0x6178     OCE_MAIN_FW      FWCFG2                [3]        PPTGEARING          0x1
// 0x6178     OCE_MAIN_FW      FWCFG2                [2]        SUNCLEARBESTPEAK    0x1
// 0x6178     OCE_MAIN_FW      FWCFG2                [1:0]      PHR_MCS             0x1
// 0x61AC     OCE_MAIN_FW      FWCFG3                [1]        STRICTENABLE        0x1
// 0x61AC     OCE_MAIN_FW      FWCFG3                [0]        NOSYNC              0x0
// 0x6220     LRFDOCE          IFFTSAT               [8:0]      VAL                 0x000
// 0x0004     PBE_RAM          MCEPOLY0L             [15:0]     VAL                 0x0000
// 0x0006     PBE_RAM          MCEPOLY0H             [15:0]     VAL                 0x8005
// 0x0008     PBE_RAM          MCEPOLY1L             [15:0]     VAL                 0x0000
// 0x000A     PBE_RAM          MCEPOLY1H             [15:0]     VAL                 0x8005
// 0x000C     PBE_RAM          MCELFSR0INITL         [15:0]     VAL                 0x0000
// 0x000E     PBE_RAM          MCELFSR0INITH         [15:0]     VAL                 0xFFFF
// 0x0010     PBE_RAM          MCELFSR1INITL         [15:0]     VAL                 0x0000
// 0x0012     PBE_RAM          MCELFSR1INITH         [15:0]     VAL                 0xFFFF
// 0x0014     PBE_RAM          MCECRCXORL            [15:0]     VAL                 0x0000
// 0x0016     PBE_RAM          MCECRCXORH            [15:0]     VAL                 0x0000
...
// 0x8008     OCE_MAIN_RAM     SUNSTFTHR_LOW         [15:0]     VALUE               0x0013
// 0x800C     OCE_MAIN_RAM     SUNLTFTHR             [15:0]     VALUE               0x012C
