...
#include "rcl_settings_2gfsk9p6kbps.h"


// Configuration: FRONTEND
const uint32_t LRF_frontendRegConfig_2gfsk9p6kbps[] =
{
...
const uint32_t LRF_frontendRegConfig_2gfsk9p6kbps_byteCount = sizeof(LRF_frontendRegConfig_2gfsk9p6kbps);


// Configuration: MAIN
const uint32_t LRF_mainRegConfig_2gfsk9p6kbps[] =
{
    ...
    0x00000960,    //         TRX_swParam : modFrequencyDeviation
    0x00000201,    //         TRX_swParam : radioRequirements.defaultModem, radioRequirements.supportedRfModes
    ...
    0x30B800CB,    //         LRFDRFE.RX0BDEC
    0x30C0000D,    //         LRFDRFE.RX0CICHF
    0x30E400C8,    //         LRFDRFE.RX1BDEC
    ...
    0x0000816F,    //         LRFDMCE.BAUD1            LRFDMCE.BAUD0
    0x0000004F,    //         -                        LRFDMCE.BAUDPRE
    ...
    0x213E9405,    //         RFE_FW.AGCCFG3           RFE_FW.AGCCFG2
    0x319C1001,    //     HW 16-bit region (start address = 0x319C, count = 2)
    0x00930216,    //         LRFDRFE.RFECTL1          LRFDRFE.RFECTL0
    ...
    0xC1000302,    //         LRFDRFE.PRE1             LRFDRFE.PRE0
    ...
    0x1F10DF7F,    //         LRFDRFE.PLLMON1          LRFDRFE.PLLMON0
    ...
    0x00525090,    //         RFE_FW.PHYRX0RSSI        LRFDRFE.SPARE0
    0x08240052,    //         RFE_FW.PHYAGCCFG4        RFE_FW.PHYRX1RSSI
    ...
    0x00000010,    //         RFE_RAM.TDCPLL           RFE_RAM.TDCCAL2
    0x010A569B,    //         RFE_RAM.K1MSB            RFE_RAM.K1LSB
    0x003D0101,    //         RFE_RAM.K2AL             RFE_RAM.K2BL
    0x0D6C2659,    //         RFE_RAM.K3AL             RFE_RAM.K3BL
...
const uint32_t LRF_mainRegConfig_2gfsk9p6kbps_byteCount = sizeof(LRF_mainRegConfig_2gfsk9p6kbps);

// TRX_TxPowerLevels data structure
const TRX_TxPowerLevels TRX_txPowerLevels_2gfsk9p6kbps = {
    .numEntries  = 0x18,
    .powerLevels = {
        { .fraction = 0, .dBm = -30 },
        { .fraction = 0, .dBm = -20 },
...
// TRX_TxPowerLevels data structure
const TRX_TxPowerLevels TRX_txPowerLevelsHigh_2gfsk9p6kbps = {
    .numEntries  = 0x13,
    .powerLevels = {
        { .fraction = 0, .dBm =   0 },
        { .fraction = 0, .dBm =   5 },
