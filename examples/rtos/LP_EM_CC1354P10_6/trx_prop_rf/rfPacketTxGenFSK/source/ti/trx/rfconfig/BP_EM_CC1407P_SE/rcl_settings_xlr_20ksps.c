...
#include "rcl_settings_xlr_20ksps.h"


// Configuration: FRONTEND
const uint32_t LRF_frontendRegConfig_xlr20ksps[] =
{
...
const uint32_t LRF_frontendRegConfig_xlr20ksps_byteCount = sizeof(LRF_frontendRegConfig_xlr20ksps);


// Configuration: MAIN
const uint32_t LRF_mainRegConfig_xlr20ksps[] =
{
    0x00008097,    // 4 segment(s), total length = 151
    0x0000008D,    // Segment length = 141
    ...
    0x00001388,    //         TRX_swParam : modFrequencyDeviation
    0x00000041,    //         TRX_swParam : radioRequirements.defaultModem, radioRequirements.supportedRfModes
    ...
    0x0000301C,    //     HW sparse region (address/value pairs, count = 29)
    0x106000FA,    //         PBE_FW.CMDPAR1
    0x10881F37,    //         PBE_FW.MCECMDPAR0
    0x10905555,    //         PBE_FW.MODPREAMBLESHD
    0x115C1328,    //         PBE_FW.PKTCFG
    0x11640483,    //         PBE_FW.FSKCFG
    ...
    0x30B80086,    //         LRFDRFE.RX0BDEC
    0x30C00015,    //         LRFDRFE.RX0CICHF
    0x30E40084,    //         LRFDRFE.RX1BDEC
    ...
    0x00010000,    //         LRFDMCE.BAUD1            LRFDMCE.BAUD0
    0x0000004B,    //         -                        LRFDMCE.BAUDPRE
    ...
    0x00540124,    //         LRFDMCE.DEMD2XB0         LRFDMCE.DEMDSXB0
    0x21001007,    //     HW 16-bit region (start address = 0x2100, count = 8)
    0x48200800,    //         LRFDMCE.DEMMAFI1         LRFDMCE.DEMMAFI0
    0x00000048,    //         LRFDMCE.DEMMAFI3         LRFDMCE.DEMMAFI2
    0x7F7F001F,    //         LRFDMCE.DEMC1BE1         LRFDMCE.DEMC1BE0
    0x8004004C,    //         LRFDMCE.DEMC1BE10        LRFDMCE.DEMC1BE2
    0x21241004,    //     HW 16-bit region (start address = 0x2124, count = 5)
    0x146F3C2E,    //         LRFDMCE.MDMSYNC0         LRFDMCE.DEMC1BE12
    0x0000EB90,    //         LRFDMCE.MDMSYNC2         LRFDMCE.MDMSYNC1
    0x00000000,    //         -                        LRFDMCE.MDMSYNC3
    0x21AC1001,    //     HW 16-bit region (start address = 0x21AC, count = 2)
    0x0028000C,    //         LRFDMCE.SPARE1           LRFDMCE.SPARE0
    ...
    0x00C64C0A,    //         LRFDRFE.IFAMP            LRFDRFE.LNA
    ...
    0x004D5090,    //         RFE_FW.PHYRX0RSSI        LRFDRFE.SPARE0
    0x1221004D,    //         RFE_FW.PHYAGCCFG4        RFE_FW.PHYRX1RSSI
    ...
    0x00034002,    // Segment length = 2 (DSSS = 2)
    0x00003000,    //     HW sparse region (address/value pairs, count = 1)
    0x21C00001,    //         LRFDMCE.SPARE5
    0x00010002,    // Segment length = 2 (DSSS = 4)
    0x00003000,    //     HW sparse region (address/value pairs, count = 1)
    0x21C00003,    //         LRFDMCE.SPARE5
    0x00020002,    // Segment length = 2 (DSSS = 8)
    0x00003000,    //     HW sparse region (address/value pairs, count = 1)
    0x21C00007     //         LRFDMCE.SPARE5
};

// Configuration length: MAIN
const uint32_t LRF_mainRegConfig_xlr20ksps_byteCount = sizeof(LRF_mainRegConfig_xlr20ksps);

// TRX_TxPowerLevels data structure
const TRX_TxPowerLevels TRX_txPowerLevels_xlr20ksps = {
    .numEntries  = 0x18,
    .powerLevels = {
        { .fraction = 0, .dBm = -30 },
        { .fraction = 0, .dBm = -20 },
...
// TRX_TxPowerLevels data structure
const TRX_TxPowerLevels TRX_txPowerLevelsHigh_xlr20ksps = {
    .numEntries  = 0x13,
    .powerLevels = {
        { .fraction = 0, .dBm =   0 },
        { .fraction = 0, .dBm =   5 },
