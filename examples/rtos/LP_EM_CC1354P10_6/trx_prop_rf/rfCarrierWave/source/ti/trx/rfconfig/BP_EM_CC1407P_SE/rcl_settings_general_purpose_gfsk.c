...
#include "rcl_settings_general_purpose_gfsk.h"


// Configuration: FRONTEND
const uint32_t LRF_frontendRegConfig_generalPurposeGfsk[] =
{
...
const uint32_t LRF_frontendRegConfig_generalPurposeGfsk_byteCount = sizeof(LRF_frontendRegConfig_generalPurposeGfsk);


// Configuration: MAIN
const uint32_t LRF_mainRegConfig_generalPurposeGfsk[] =
{
    0x000080A9,    // 5 segment(s), total length = 169
    0x00000094,    // Segment length = 148
    ...
    0x00415090,    //         RFE_FW.PHYRX0RSSI        LRFDRFE.SPARE0
    0x122B0041,    //         RFE_FW.PHYAGCCFG4        RFE_FW.PHYRX1RSSI
...
const uint32_t LRF_mainRegConfig_generalPurposeGfsk_byteCount = sizeof(LRF_mainRegConfig_generalPurposeGfsk);

// TRX_TxPowerLevels data structure
const TRX_TxPowerLevels TRX_txPowerLevels_generalPurposeGfsk = {
    .numEntries  = 0x18,
    .powerLevels = {
        { .fraction = 0, .dBm = -30 },
        { .fraction = 0, .dBm = -20 },
...
// TRX_TxPowerLevels data structure
const TRX_TxPowerLevels TRX_txPowerLevelsHigh_generalPurposeGfsk = {
    .numEntries  = 0x13,
    .powerLevels = {
        { .fraction = 0, .dBm =   0 },
        { .fraction = 0, .dBm =   5 },
