...
#include "rcl_settings_2gfsk50kbps.h"


// Configuration: FRONTEND
const uint32_t LRF_frontendRegConfig_2gfsk50kbps[] =
{
...
const uint32_t LRF_frontendRegConfig_2gfsk50kbps_byteCount = sizeof(LRF_frontendRegConfig_2gfsk50kbps);


// Configuration: MAIN
const uint32_t LRF_mainRegConfig_2gfsk50kbps[] =
{
    0x000080A8,    // 5 segment(s), total length = 168
    0x00000093,    // Segment length = 147
    ...
    0x21AC2A30,    //         MCE_MAIN_FW.FWCFG0
    0x21B48000,    //         MCE_MAIN_FW.FWCFG2
...
const uint32_t LRF_mainRegConfig_2gfsk50kbps_byteCount = sizeof(LRF_mainRegConfig_2gfsk50kbps);

// TRX_TxPowerLevels data structure
const TRX_TxPowerLevels TRX_txPowerLevels_2gfsk50kbps = {
    .numEntries  = 0x18,
    .powerLevels = {
        { .fraction = 0, .dBm = -30 },
        { .fraction = 0, .dBm = -20 },
...
// TRX_TxPowerLevels data structure
const TRX_TxPowerLevels TRX_txPowerLevelsHigh_2gfsk50kbps = {
    .numEntries  = 0x13,
    .powerLevels = {
        { .fraction = 0, .dBm =   0 },
        { .fraction = 0, .dBm =   5 },
