...
#include "rcl_settings_ofdmlr_8p33ksps.h"


// Configuration: FRONTEND
const uint32_t LRF_frontendRegConfig_ofdmlr8p33ksps[] =
{
...
const uint32_t LRF_frontendRegConfig_ofdmlr8p33ksps_byteCount = sizeof(LRF_frontendRegConfig_ofdmlr8p33ksps);


// Configuration: MAIN
const uint32_t LRF_mainRegConfig_ofdmlr8p33ksps[] =
{
    ...
    0x11680006,    //         PBE_FW.OFDM0
    0x3064001E,    //         LRFDRFE.TXENABLE
    0x30880000,    //         LRFDRFE.RXADCDIG
    0x30A40E00,    //         LRFDRFE.RX0CODC0
    0x30B80048,    //         LRFDRFE.RX0BDEC
    0x30C00108,    //         LRFDRFE.RX0CICHF
    0x30E40048,    //         LRFDRFE.RX1BDEC
    0x30EC0008,    //         LRFDRFE.RX1CICHF
    ...
    0x2708D305,    //         RFE_FW.AGCCFG3           RFE_FW.AGCCFG2
    ...
    0x0056450A,    //         LRFDRFE.IFAMP            LRFDRFE.LNA
...
const uint32_t LRF_mainRegConfig_ofdmlr8p33ksps_byteCount = sizeof(LRF_mainRegConfig_ofdmlr8p33ksps);

// TRX_TxPowerLevels data structure
const TRX_TxPowerLevels TRX_txPowerLevels_ofdmlr8p33ksps = {
    .numEntries  = 0x18,
    .powerLevels = {
        { .fraction = 0, .dBm = -30 },
        { .fraction = 0, .dBm = -20 },
...
// TRX_TxPowerLevels data structure
const TRX_TxPowerLevels TRX_txPowerLevelsHigh_ofdmlr8p33ksps = {
    .numEntries  = 0x13,
    .powerLevels = {
        { .fraction = 0, .dBm =   0 },
        { .fraction = 0, .dBm =   5 },
