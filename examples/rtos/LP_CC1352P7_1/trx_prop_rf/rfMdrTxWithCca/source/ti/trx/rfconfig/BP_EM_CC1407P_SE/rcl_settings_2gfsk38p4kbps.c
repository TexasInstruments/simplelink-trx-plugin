...
#include "rcl_settings_2gfsk38p4kbps.h"


// Configuration: FRONTEND
const uint32_t LRF_frontendRegConfig_2gfsk38p4kbps[] =
{
...
const uint32_t LRF_frontendRegConfig_2gfsk38p4kbps_byteCount = sizeof(LRF_frontendRegConfig_2gfsk38p4kbps);


// Configuration: MAIN
const uint32_t LRF_mainRegConfig_2gfsk38p4kbps[] =
{
...
const uint32_t LRF_mainRegConfig_2gfsk38p4kbps_byteCount = sizeof(LRF_mainRegConfig_2gfsk38p4kbps);

// TRX_TxPowerLevels data structure
const TRX_TxPowerLevels TRX_txPowerLevels_2gfsk38p4kbps = {
    .numEntries  = 0x18,
    .powerLevels = {
        { .fraction = 0, .dBm = -30 },
        { .fraction = 0, .dBm = -20 },
...
// TRX_TxPowerLevels data structure
const TRX_TxPowerLevels TRX_txPowerLevelsHigh_2gfsk38p4kbps = {
    .numEntries  = 0x13,
    .powerLevels = {
        { .fraction = 0, .dBm =   0 },
        { .fraction = 0, .dBm =   5 },
