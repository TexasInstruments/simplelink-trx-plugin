...
// PHY                                        779 - 930 MHz - Proprietary - SimpleLink OFDM Long-Range - 16.67 ksps, 550 kHz signal BW
//     State                                  Experimental
// PHY abbreviation                           ofdmlr_16p67ksps
//
//
// PHY PROPERTIES
//
// Fixed properties:
//     Symbol duration                        60 us 
...
// Packet data:
//     Spreading mode in TX (header field)    (6,1)-DSSS
//         Data rate                          1.39 kbps

#ifndef RCLSETTINGSOFDMLR16P67KSPS_H
#define RCLSETTINGSOFDMLR16P67KSPS_H
...
#define TRX_CLOCK_CONFIG_OFDMLR_16P67KSPS     TRX_ClockConfig_XOSC

// Supported RF modes (may be chosen freely)
#define TRX_RF_MODE_OFDMLR_16P67KSPS          TRX_RfMode_SUN
#define TRX_RF_MODE_ALT_1_OFDMLR_16P67KSPS    TRX_RfMode_PropFSK
#define TRX_RF_MODE_ALT_2_OFDMLR_16P67KSPS    TRX_RfMode_XLR


// Configuration: FRONTEND
extern const uint32_t LRF_frontendRegConfig_ofdmlr16p67ksps[];
// Configuration length: FRONTEND
extern const uint32_t LRF_frontendRegConfig_ofdmlr16p67ksps_byteCount;
// Configuration: MAIN
extern const uint32_t LRF_mainRegConfig_ofdmlr16p67ksps[];
// Configuration length: MAIN
extern const uint32_t LRF_mainRegConfig_ofdmlr16p67ksps_byteCount;


// TRX data structures
extern const TRX_TxPowerLevels	TRX_txPowerLevels_ofdmlr16p67ksps;
extern const TRX_TxPowerLevels	TRX_txPowerLevelsHigh_ofdmlr16p67ksps;
...
// 0x1168     PBE_FW         OFDM0                 [2:1]      LROPTION            0x1
...
// 0x311C     RFE_FW         AGCCFG3               [11:0]     TIMEOUT             0x384
...
// 0x31BC     LRFDRFE        LNA                   [11:8]     MIXCAP              0x2
...
// 0x31C0     LRFDRFE        IFAMP                 [7:4]      IFFCAP              0x2
...
// 0x6120     LRFDOCE        LRFFT0                [11:10]    NDT                 0x2
// 0x6120     LRFDOCE        LRFFT0                [9:8]      RXDFTSZ             0x2
...
// 0x6128     LRFDOCE        LRMDM3                [6:5]      TXDFTSZ             0x2
// 0x6128     LRFDOCE        LRMDM3                [4:0]      MODFINEGAIN         0x03
// 0x612C     LRFDOCE        LRDEM0                [15:0]     RXSIGNALREF         0x07F7
// 0x6130     LRFDOCE        LRDEM1                [7:0]      RXFIRSTDATASAMPL    0x2D
// 0x6134     LRFDOCE        LRDEM2                [11:9]     BDEC_NUM_STAGES     0x2
// 0x6134     LRFDOCE        LRDEM2                [6:5]      SYNCBDECDVGA        0x0
// 0x6134     LRFDOCE        LRDEM2                [3:0]      NORMPERIOD          0x5
// 0x613C     LRFDOCE        LRDEM5                [12:0]     CMIXN               0x1E00
...
// 0x6144     LRFDOCE        LRCORR1               [12:8]     RAKEACTIVE          0x1F
