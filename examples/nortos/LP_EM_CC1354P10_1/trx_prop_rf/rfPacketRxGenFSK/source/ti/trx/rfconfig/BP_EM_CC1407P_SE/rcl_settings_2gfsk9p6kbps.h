...
// PHY                                       779 - 930 MHz - Proprietary - 9.6 kbps, 2.4 kHz dev, 2-GFSK
//     State                                 Experimental
// PHY abbreviation                          2gfsk9p6kbps
//
//
// PHY PROPERTIES
//
...
//     Whitening                             Disabled
// RF channel:
//     Center frequency                      869.225 MHz 
//     Symbol rate                           9.60000 kBaud 
//     Deviation                             2.400 kHz 
//     RX filter bandwidth                   17.660 kHz 
//     Modulation                            2-GFSK 
// Start of packet:
...
#ifndef RCLSETTINGS2GFSK9P6KBPS_H
#define RCLSETTINGS2GFSK9P6KBPS_H
...
// PHY features
#define TRX_PHY_FEATURE_WHITENING_DISABLED_2GFSK9P6KBPS             0x0000
#define TRX_PHY_FEATURE_WHITENING_CC1101_COMPATIBLE_2GFSK9P6KBPS    0x0001
#define TRX_PHY_FEATURE_TX_SYNC_WORD_A_2GFSK9P6KBPS                 0x0000
#define TRX_PHY_FEATURE_TX_SYNC_WORD_B_2GFSK9P6KBPS                 0x0002


// Supported clock configuration
#define TRX_CLOCK_CONFIG_2GFSK9P6KBPS                               TRX_ClockConfig_XOSC

// Supported RF mode
#define TRX_RF_MODE_2GFSK9P6KBPS                                    TRX_RfMode_PropFSKPeakAGC


// Configuration: FRONTEND
extern const uint32_t LRF_frontendRegConfig_2gfsk9p6kbps[];
// Configuration length: FRONTEND
extern const uint32_t LRF_frontendRegConfig_2gfsk9p6kbps_byteCount;
// Configuration: MAIN
extern const uint32_t LRF_mainRegConfig_2gfsk9p6kbps[];
// Configuration length: MAIN
extern const uint32_t LRF_mainRegConfig_2gfsk9p6kbps_byteCount;


// TRX data structures
extern const TRX_TxPowerLevels	TRX_txPowerLevels_2gfsk9p6kbps;
extern const TRX_TxPowerLevels	TRX_txPowerLevelsHigh_2gfsk9p6kbps;
...
// 0x20C4     LRFDMCE        BAUDPRE               [7:0]      PRESCALER           0x4F
...
// 0x2100     LRFDMCE        DEMMAFI0              [15:8]     C1C7                0x04
// 0x2100     LRFDMCE        DEMMAFI0              [7:0]      C0C8                0x00
// 0x2104     LRFDMCE        DEMMAFI1              [15:8]     C3C5                0x7C
// 0x2104     LRFDMCE        DEMMAFI1              [7:0]      C2C6                0x20
// 0x2108     LRFDMCE        DEMMAFI2              [8:0]      C4                  0x0C2
...
// 0x21AC     MCE_MAIN_FW    FWCFG0                [11:8]     FB2PLLGAIN          0x3
// 0x21AC     MCE_MAIN_FW    FWCFG0                [7:0]      FB2PLLLIMIT         0x1B
...
// 0x30B8     LRFDRFE        RX0BDEC               [7:6]      BDE2DVGA            0x3
// 0x30B8     LRFDRFE        RX0BDEC               [5:4]      BDE1DVGA            0x0
// 0x30B8     LRFDRFE        RX0BDEC               [3:2]      BDEC2NUMSTAGES      0x2
// 0x30B8     LRFDRFE        RX0BDEC               [1:0]      BDEC1NUMSTAGES      0x3
// 0x30C0     LRFDRFE        RX0CICHF              [5:2]      CICDEC              0x3
...
// 0x3118     RFE_FW         AGCCFG2               [11:8]     SETTLEWAIT          0x4
...
// 0x311C     RFE_FW         AGCCFG3               [11:0]     TIMEOUT             0x13E
...
// 0x319C     LRFDRFE        RFECTL0               [2]        IIR                 0x1
// 0x319C     LRFDRFE        RFECTL0               [1]        REFDTHR             0x1
// 0x319C     LRFDRFE        RFECTL0               [0]        FCDEM               0x0
// 0x31A0     LRFDRFE        RFECTL1               [15:5]     SPARE               0x004
// 0x31A0     LRFDRFE        RFECTL1               [4]        IQIC                0x1
...
// 0x3268     LRFDRFE        PRE0                  [13:8]     PLLDIV1             0x03
// 0x3268     LRFDRFE        PRE0                  [5:0]      PLLDIV0             0x02
// 0x326C     LRFDRFE        PRE1                  [15:14]    IIRBW               0x3
// 0x326C     LRFDRFE        PRE1                  [13]       IIRORD              0x0
// 0x326C     LRFDRFE        PRE1                  [12:8]     IIRDIV              0x01
...
// 0x32A4     LRFDRFE        PLLMON1               [12:8]     PHELOCKCNT          0x1F
...
// 0x3394     RFE_FW         PHYRX0RSSI            [7:0]      OFFSET              0x52
// 0x3398     RFE_FW         PHYRX1RSSI            [7:0]      OFFSET              0x52
// 0x339C     RFE_FW         PHYAGCCFG4            [15:8]     NOSIGNALTHR         0x08
// 0x339C     RFE_FW         PHYAGCCFG4            [7:0]      AGCIRQTHR           0x24
...
// 0x680A     RFE_RAM        TDCPLL                [10:8]     STOP                0x0
// 0x680C     RFE_RAM        K1LSB                 [15:0]     VAL                 0x569B
// 0x680E     RFE_RAM        K1MSB                 [15:0]     VAL                 0x010A
// 0x6810     RFE_RAM        K2BL                  [15]       HPM                 0x0
// 0x6810     RFE_RAM        K2BL                  [14:0]     VAL                 0x0101
// 0x6812     RFE_RAM        K2AL                  [15]       HPM                 0x0
// 0x6812     RFE_RAM        K2AL                  [14:0]     VAL                 0x003D
// 0x6814     RFE_RAM        K3BL                  [15:0]     VAL                 0x2659
// 0x6816     RFE_RAM        K3AL                  [15:0]     VAL                 0x0D6C
