...
// PHY                                        779 - 930 MHz - Proprietary - SimpleLink OFDM Long-Range - 8.33 ksps, 156 kHz signal BW
//     State                                  Experimental
// PHY abbreviation                           ofdmlr_8p33ksps
//
//
// PHY PROPERTIES
//
// Fixed properties:
//     Symbol duration                        120 us 
...
#ifndef RCLSETTINGSOFDMLR8P33KSPS_H
#define RCLSETTINGSOFDMLR8P33KSPS_H
...
#define TRX_CLOCK_CONFIG_OFDMLR_8P33KSPS     TRX_ClockConfig_XOSC

// Supported RF modes (may be chosen freely)
#define TRX_RF_MODE_OFDMLR_8P33KSPS          TRX_RfMode_SUN
#define TRX_RF_MODE_ALT_1_OFDMLR_8P33KSPS    TRX_RfMode_PropFSK
#define TRX_RF_MODE_ALT_2_OFDMLR_8P33KSPS    TRX_RfMode_XLR


// Configuration: FRONTEND
extern const uint32_t LRF_frontendRegConfig_ofdmlr8p33ksps[];
// Configuration length: FRONTEND
extern const uint32_t LRF_frontendRegConfig_ofdmlr8p33ksps_byteCount;
// Configuration: MAIN
extern const uint32_t LRF_mainRegConfig_ofdmlr8p33ksps[];
// Configuration length: MAIN
extern const uint32_t LRF_mainRegConfig_ofdmlr8p33ksps_byteCount;


// TRX data structures
extern const TRX_TxPowerLevels	TRX_txPowerLevels_ofdmlr8p33ksps;
extern const TRX_TxPowerLevels	TRX_txPowerLevelsHigh_ofdmlr8p33ksps;
...
// 0x1168     PBE_FW         OFDM0                 [2:1]      LROPTION            0x3
// 0x1168     PBE_FW         OFDM0                 [0]        SUNOFDM             0x0
// 0x3064     LRFDRFE        TXENABLE              [4]        INTP4               0x1
...
// 0x30C0     LRFDRFE        RX0CICHF              [5:2]      CICDEC              0x2
...
// 0x30EC     LRFDRFE        RX1CICHF              [5:2]      CICDEC              0x2
...
// 0x311C     RFE_FW         AGCCFG3               [11:0]     TIMEOUT             0x708
...
// 0x31BC     LRFDRFE        LNA                   [11:8]     MIXCAP              0x5
...
// 0x31C0     LRFDRFE        IFAMP                 [7:4]      IFFCAP              0x5
...
// 0x6168     OCE_MAIN_FW    FWCFG4                [7:0]      LROFDMPHY           0x09
