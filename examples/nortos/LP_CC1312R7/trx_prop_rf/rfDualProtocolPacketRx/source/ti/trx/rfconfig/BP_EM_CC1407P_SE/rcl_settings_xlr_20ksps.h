...
// PHY                                 779 - 930 MHz - Proprietary - Extended Long Range - 20 ksps, 10 kHz dev
//     State                           Experimental
// PHY abbreviation                    xlr_20ksps
//
//
// PHY PROPERTIES
//
...
//     Spreading mode                  (2,1)-DSSS
//         Data rate                   5.00 kbps
// Packet format:
//     Maximum payload length in RX    250 bytes

#ifndef RCLSETTINGSXLR20KSPS_H
#define RCLSETTINGSXLR20KSPS_H
...
// PHY features
#define TRX_PHY_FEATURE_DSSS_2_XLR_20KSPS    0x0000
#define TRX_PHY_FEATURE_DSSS_4_XLR_20KSPS    0x0001
#define TRX_PHY_FEATURE_DSSS_8_XLR_20KSPS    0x0002


// Supported clock configuration
#define TRX_CLOCK_CONFIG_XLR_20KSPS          TRX_ClockConfig_XOSC

// Supported RF mode
#define TRX_RF_MODE_XLR_20KSPS               TRX_RfMode_XLR


// Configuration: FRONTEND
extern const uint32_t LRF_frontendRegConfig_xlr20ksps[];
// Configuration length: FRONTEND
extern const uint32_t LRF_frontendRegConfig_xlr20ksps_byteCount;
// Configuration: MAIN
extern const uint32_t LRF_mainRegConfig_xlr20ksps[];
// Configuration length: MAIN
extern const uint32_t LRF_mainRegConfig_xlr20ksps_byteCount;


// TRX data structures
extern const TRX_TxPowerLevels	TRX_txPowerLevels_xlr20ksps;
extern const TRX_TxPowerLevels	TRX_txPowerLevelsHigh_xlr20ksps;
...
// ------------------------------------------------------------------------------------------------------------------
// 0x1060     PBE_FW         CMDPAR1               [14:0]     PKTSZ               0x00FA
...
// 0x1164     PBE_FW         FSKCFG                [10]       SLR                 0x1
...
// 0x2068     LRFDMCE        RFCHANNEL             [11:0]     VAL                 0x001
// 0x209C     LRFDMCE        OCESEND               [7:0]      VAL                 0x00
// 0x20A4     LRFDMCE        CCESEND               [7:0]      VAL                 0x00
// 0x20B4     LRFDMCE        MODSYMMAP1            [7:4]      SYM5                0x1
// 0x20B4     LRFDMCE        MODSYMMAP1            [3:0]      SYM4                0xF
// 0x20BC     LRFDMCE        BAUD0                 [15:0]     RATEWORD            0x0000
// 0x20C0     LRFDMCE        BAUD1                 [4:0]      EXTRATEWORD         0x01
// 0x20C4     LRFDMCE        BAUDPRE               [7:0]      PRESCALER           0x4B
...
// 0x20E0     LRFDMCE        DEMDSBU               [8:0]      DSBUDELAY           0x00C
// 0x20F4     LRFDMCE        DEMDSXB0              [11:10]    OUTSRCSEL2          0x0
// 0x20F4     LRFDMCE        DEMDSXB0              [9:8]      OUTSRCSEL1          0x1
// 0x20F4     LRFDMCE        DEMDSXB0              [5:4]      B3SRCSEL            0x2
// 0x20F4     LRFDMCE        DEMDSXB0              [3:2]      B2SRCSEL            0x1
...
// 0x2100     LRFDMCE        DEMMAFI0              [15:8]     C1C7                0x08
// 0x2100     LRFDMCE        DEMMAFI0              [7:0]      C0C8                0x00
// 0x2104     LRFDMCE        DEMMAFI1              [15:8]     C3C5                0x48
// 0x2104     LRFDMCE        DEMMAFI1              [7:0]      C2C6                0x20
// 0x2108     LRFDMCE        DEMMAFI2              [8:0]      C4                  0x048
// 0x210C     LRFDMCE        DEMMAFI3              [9:0]      K                   0x000
// 0x2110     LRFDMCE        DEMC1BE0              [15:11]    MASKB               0x00
// 0x2110     LRFDMCE        DEMC1BE0              [10:6]     MASKA               0x00
// 0x2110     LRFDMCE        DEMC1BE0              [5:4]      CASCCONF            0x1
// 0x2110     LRFDMCE        DEMC1BE0              [3:0]      COPYCONF            0xF
// 0x2114     LRFDMCE        DEMC1BE1              [15:8]     THRESHOLDB          0x7F
// 0x2114     LRFDMCE        DEMC1BE1              [7:0]      THRESHOLDA          0x7F
// 0x2118     LRFDMCE        DEMC1BE2              [9:8]      PEAKCONF            0x0
// 0x2118     LRFDMCE        DEMC1BE2              [7:0]      THRESHOLDC          0x4C
// 0x211C     LRFDMCE        DEMC1BE10             [15]       PEAKCONFG           0x1
// 0x211C     LRFDMCE        DEMC1BE10             [12:8]     MASKE               0x00
// 0x211C     LRFDMCE        DEMC1BE10             [2:0]      CASCCONF            0x4
// 0x2124     LRFDMCE        DEMC1BE12             [15:8]     THRESHOLDG          0x3C
// 0x2124     LRFDMCE        DEMC1BE12             [7:0]      THRESHOLDF          0x2E
// 0x2128     LRFDMCE        MDMSYNC0              [15:0]     SWA15C0             0x146F
// 0x212C     LRFDMCE        MDMSYNC1              [15:0]     SWA31C16            0xEB90
// 0x2130     LRFDMCE        MDMSYNC2              [15:0]     SWB15C0             0x0000
// 0x2134     LRFDMCE        MDMSYNC3              [15:0]     SWB31C16            0x0000
// 0x213C     LRFDMCE        DEMCMIXFB2P           [1:0]      CTL                 0x1
// 0x2180     LRFDMCE        DEMWMCFG              [7:6]      SCALING             0x1
// 0x21AC     LRFDMCE        SPARE0                [15:0]     VAL                 0x000C
// 0x21B0     LRFDMCE        SPARE1                [15:0]     VAL                 0x0028
...
// 0x30B8     LRFDRFE        RX0BDEC               [7:6]      BDE2DVGA            0x2
// 0x30B8     LRFDRFE        RX0BDEC               [5:4]      BDE1DVGA            0x0
// 0x30B8     LRFDRFE        RX0BDEC               [3:2]      BDEC2NUMSTAGES      0x1
// 0x30B8     LRFDRFE        RX0BDEC               [1:0]      BDEC1NUMSTAGES      0x2
...
// 0x30E4     LRFDRFE        RX1BDEC               [3:2]      BDEC2NUMSTAGES      0x1
...
// 0x31BC     LRFDRFE        LNA                   [11:8]     MIXCAP              0xC
...
// 0x31C0     LRFDRFE        IFAMP                 [7:4]      IFFCAP              0xC
...
// 0x3394     RFE_FW         PHYRX0RSSI            [7:0]      OFFSET              0x4D
...
// MAIN : DSSS register field values

// Address    Module         Register              Bit(s)     Field               Value (2)    Value (4)    Value (8)
// ------------------------------------------------------------------------------------------------------------------
// 0x21C0     LRFDMCE        SPARE5                [15:0]     VAL                 0x0001       0x0003       0x0007
