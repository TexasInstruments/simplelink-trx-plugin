...
#include "rcl_settings_ofdmlr_16p67ksps.h"


// Configuration: FRONTEND
const uint32_t LRF_frontendRegConfig_ofdmlr16p67ksps[] =
{
...
const uint32_t LRF_frontendRegConfig_ofdmlr16p67ksps_byteCount = sizeof(LRF_frontendRegConfig_ofdmlr16p67ksps);


// Configuration: MAIN
const uint32_t LRF_mainRegConfig_ofdmlr16p67ksps[] =
{
    0x0000806F,    // 1 segment(s), total length = 111
    0x0000006E,    // Segment length = 110
    ...
    0x00003013,    //     HW sparse region (address/value pairs, count = 20)
    0x115C061F,    //         PBE_FW.PKTCFG
    0x11680002,    //         PBE_FW.OFDM0
    ...
    0x2384D305,    //         RFE_FW.AGCCFG3           RFE_FW.AGCCFG2
    ...
    0x0026420A,    //         LRFDRFE.IFAMP            LRFDRFE.LNA
    ...
    0x00260047,    //         RFE_FW.PHYAGCCFG4        RFE_FW.PHYRX1RSSI
    ...
    0x00248A25,    //         LRFDOCE.LRFEC0           LRFDOCE.LRFFT0
    0x07F70043,    //         LRFDOCE.LRDEM0           LRFDOCE.LRMDM3
    0x0405002D,    //         LRFDOCE.LRDEM2           LRFDOCE.LRDEM1
    0x613C1002,    //     HW 16-bit region (start address = 0x613C, count = 3)
    0x00BD1E00,    //         LRFDOCE.LRCORR0          LRFDOCE.LRDEM5
    0x00007F2B,    //         -                        LRFDOCE.LRCORR1
    ...
    0x5A46331F,    //         LRFDOCE.SPARE4           OCE_MAIN_FW.FWCFG0
...
const uint32_t LRF_mainRegConfig_ofdmlr16p67ksps_byteCount = sizeof(LRF_mainRegConfig_ofdmlr16p67ksps);

// TRX_TxPowerLevels data structure
const TRX_TxPowerLevels TRX_txPowerLevels_ofdmlr16p67ksps = {
    .numEntries  = 0x18,
    .powerLevels = {
        { .fraction = 0, .dBm = -30 },
        { .fraction = 0, .dBm = -20 },
...
// TRX_TxPowerLevels data structure
const TRX_TxPowerLevels TRX_txPowerLevelsHigh_ofdmlr16p67ksps = {
    .numEntries  = 0x13,
    .powerLevels = {
        { .fraction = 0, .dBm =   0 },
        { .fraction = 0, .dBm =   5 },
